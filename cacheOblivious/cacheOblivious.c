    ...
    int *B, size_t offset_row_B, size_t offset_col_B)
{
    ...
    {
        n >>= 1;
        recursiveMatTrans(global_n, n, A, offset_row_A, offset_col_A, B, offset_row_B, offset_col_B);                 // top left block
        recursiveMatTrans(global_n, n, A, offset_row_A, offset_col_A + n, B, offset_row_B + n, offset_col_B);         // top right block
        recursiveMatTrans(global_n, n, A, offset_row_A + n, offset_col_A, B, offset_row_B, offset_col_B + n);         // bottom left block
        recursiveMatTrans(global_n, n, A, offset_row_A + n, offset_col_A + n, B, offset_row_B + n, offset_col_B + n); // bottom right block
    }
}
